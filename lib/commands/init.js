...
function initCommand(options = {}) {
  ...
  try {
    ...
    log('   yuva status      → Show project status');
    log('   yuva list         → List all agents');
    log('   yuva doctor       → Diagnose setup issues');
    log('   yuva upgrade      → Update agent prompts\n');
  } catch (err) {
